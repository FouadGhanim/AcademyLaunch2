      ...
      <footer className="bg-white border-t border-gray-200 py-12" data-testid="footer">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-6 mb-8" data-testid="social-links">
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-all cursor-pointer" data-testid="social-facebook">
              <Facebook className="w-4 h-4 text-gray-600" />
            </div>
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-all cursor-pointer" data-testid="social-twitter">
              <Twitter className="w-4 h-4 text-gray-600" />
            </div>
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-all cursor-pointer" data-testid="social-linkedin">
              <Linkedin className="w-4 h-4 text-gray-600" />
            </div>
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-all cursor-pointer" data-testid="social-instagram">
